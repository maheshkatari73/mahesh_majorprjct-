...
def set_bg():
    ...
    <style>
    .stApp {
        background: url("https://t4.ftcdn.net/jpg/05/01/68/67/360_F_501686752_qPzSB2LT68q5KTefab0iVbUgwa1NG3Am.jpg");
...
st.set_page_config(page_title="Mental Health Assessment Chatbot", layout="wide")
set_bg()
